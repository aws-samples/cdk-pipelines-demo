...
const apiCanaryBlueprint = async function (event) {
    ...
    const url = await ssmClient.getParameter({Name: `${process.env.AWS_LAMBDA_FUNCTION_NAME.split('-')[1]}-APIURL`}).promise();
    const requestOptions = {"hostname":url.Parameter.APIURL.Value.split.split('.com/')[0] + '.com',"method":"GET","path":"/prod/","port":443}
